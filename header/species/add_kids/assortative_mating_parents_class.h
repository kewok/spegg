...
public:
	...
	void determine_parent_pair_probability(thrust::host_vector<float> *&phenotypes, thrust::host_vector<float> parental_pair_probability);
	...
	thrust::host_vector<int> females_list; 
	thrust::host_vector<int> males_list;

	int total_reproductive_females;
	int total_reproductive_males;
	
	thrust::host_vector<int> pair_populations;
...
protected:
	...
	thrust::host_vector<int> number_of_males_sampled;
	thrust::host_vector<float> assortative_mating_trait;
