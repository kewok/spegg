...
thrust::host_vector<int>::iterator inds_deme_begin, thrust::host_vector<int>::iterator inds_deme_end);
	...
	void adjust_randoms_fixed_offsets(thrust::host_vector<float>::iterator uniform_begin, thrust::host_vector<float>::iterator uniform_end, thrust::host_vector<int>::iterator inds_deme_begin, thrust::host_vector<int>::iterator inds_deme_end);
};
