...
class WhichLessThanSubsetIntegerSuccess : public ::testing::Test {
	protected:
		virtual void setup() {
		}
...
TEST_F(WhichLessThanSubsetIntegerSuccess, which_greater_than) {
	...
	which_less_than(stencil, device_answer, value, elements_evaluated);
