...
class GatherValuesByDemeFloatSuccess : public ::testing::Test {
	protected:
		virtual void setup() {
		}
...
TEST_F(GatherValuesByDemeFloatSuccess, gather_values_by_deme) {
	thrust::device_vector<int> indices(4);
	thrust::device_vector<int> demes(10);
	thrust::device_vector<float> deme_specific_values(3);
	thrust::device_vector<float> device_answer;
	thrust::host_vector<float> expected_answer(4);
	...
	deme_specific_values[0] = 100.24; deme_specific_values[1] = 1000.341; deme_specific_values[2] = 10000.58789;


	expected_answer[0] = 100.24; expected_answer[1] = 10000.58789; expected_answer[2] = 1000.341; expected_answer[3] = 1000.341;
