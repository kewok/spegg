...
void which_equal_to(thrust::host_vector<int> &stencil,
	   thrust::host_vector<int> &answer,
	   int value)
	{
	answer.resize( stencil.size() );

	thrust::host_vector<int> indices_all( stencil.size() );
...
void which_equal_to(thrust::host_vector<int> &stencil,
	...
	thrust::host_vector<int> indices_all( elements_evaluated );
	
	thrust::sequence(indices_all.begin(), indices_all.end());

	thrust::host_vector<int> stencil_local( elements_evaluated );
...
void which_greater_than(thrust::host_vector<int> &stencil,
	   thrust::host_vector<int> &answer,
	   int value)
	{
	answer.resize( stencil.size() );
...
void which_greater_than(thrust::host_vector<float> &stencil,
	   thrust::host_vector<int> &answer,
	   float value)
	{
	answer.resize( stencil.size() );
...
void which_less_than(thrust::host_vector<int> &stencil,
	   thrust::host_vector<int> &answer,
	   int value)
	{
	answer.resize( stencil.size() );
...
void which_less_than(thrust::host_vector<float> &stencil,
	   thrust::host_vector<int> &answer,
	   float value)
	{
	answer.resize( stencil.size() );
