...
void Assortative_mating_parents::determine_parent_pair_probability(thrust::host_vector<float> *&phenotypes)
	{
...
*/
	...
	thrust::host_vector<float> female_sizes(females_list.size());
...
void Assortative_mating_parents::Generate_Females_List()
{
	...
	thrust::host_vector<int> females_deme(total_reproductive_females);
	...
	thrust::host_vector<int> females_repeat(total_reproductive_females);
