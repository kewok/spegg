...
void Fish_Parents::determine_female_parent_eligibility()
	...
	float *f_sizes_at_maturity_ptr = demeParameters->get_vector_ptr("F_sizes_at_maturity");
...
void Fish_Parents::determine_male_parent_eligibility()
	...
	//Set up eligibility functor.
	float *m_sizes_at_maturity_ptr = demeParameters->get_vector_ptr("M_sizes_at_maturity");
...
void Fish_Parents::determine_probability_individual_becomes_female_parent()
	{
	float *f_reproductive_advantage = demeParameters->get_vector_ptr("F_reproductive_advantage");
...
void Fish_Parents::determine_probability_individual_becomes_male_parent()
	...
	float *m_reproductive_advantage = demeParameters->get_vector_ptr("M_reproductive_advantage");
