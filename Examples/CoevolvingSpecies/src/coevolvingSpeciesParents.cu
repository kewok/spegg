...
void coevolvingSpeciesParents::determine_male_parent_eligibility()
	...
	float *m_ages_at_maturity_ptr = raw_pointer_cast(demeParameters->get_vector_ptr("Age_at_maturity"));
...
void coevolvingSpeciesParents::determine_female_parent_eligibility()
	...
	float *f_ages_at_maturity_ptr = raw_pointer_cast(demeParameters->get_vector_ptr("Age_at_maturity"));
