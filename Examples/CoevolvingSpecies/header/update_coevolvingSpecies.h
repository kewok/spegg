...
class update_coevolvingSpecies : public UpdateBehavior
	...
	protected:
		...
		float *focal_species_phenotype;
		float *alt_species_phenotype;
		int *alt_species_status;

		thrust::device_vector<int> cumulative_deme_sizes;
		...
		thrust::device_vector<float> mean_number_of_others_sampled;
		thrust::device_vector<float> interaction_effects_on_fecundity;
		thrust::device_vector<float> interaction_effects_on_survivorship;
