...
public: 
	...
	thrust::device_vector<int> interacting_species; // species indices with which this species interacts
	...
	thrust::device_vector<float> *deme_wise_interaction_effects_on_fecundity;
	thrust::device_vector<float> *deme_wise_interaction_effects_on_survivorship;
